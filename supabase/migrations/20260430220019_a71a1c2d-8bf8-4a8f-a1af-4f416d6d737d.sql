...
BEGIN
  ...
  -- =========================================================================
  -- QUEBRA (per-installment)
  --   * Acordo cancelled (auto_expired/manual)
  --   * Parcela vence no mês alvo
  --   * Vencimento <= data de cancelamento (a.updated_at)
  --   * Parcela específica NÃO foi paga (manual_payments / negociarie_cobrancas)
  -- =========================================================================
