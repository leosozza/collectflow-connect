...
BEGIN
  ...
  -- MTD proporcional: quando o mês alvo é o mês corrente, comparamos
  -- apenas até o mesmo dia do mês anterior. Para meses fechados, mantemos
  -- a janela cheia do mês anterior.
