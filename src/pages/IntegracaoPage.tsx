...
const IntegracaoPage = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-foreground">Integração CobCloud</h1>
        <p className="text-muted-foreground">Sincronização bidirecional com a API CobCloud v3</p>
      </div>
      ...
      {logs.length > 0 && (
        <Card>
          <CardHeader>
            <CardTitle>Log de Sincronizações</CardTitle>
          </CardHeader>
          <CardContent>
