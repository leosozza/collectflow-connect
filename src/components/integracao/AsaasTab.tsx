...
import { KeyRound, Save, Loader2, CreditCard } from "lucide-react";
...
const AsaasTab = () => {
  ...
  const handleSave = async () => {
    ...
    setTimeout(() => {
      setSaving(false);
      toast.success("Credenciais do Asaas salvas com sucesso!");
    }, 1000);
  };
        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                Configure a integração do seu tenant com a conta Asaas para geração de boletos e Pix.
              </CardDescription>
            </div>
          </div>
        </CardHeader>
