...
const CenprotTab = () => {
  ...
  const handleSave = async () => {
    ...
    setTimeout(() => {
      setSaving(false);
      toast.success("Credenciais do Cenprot salvas com sucesso!");
    }, 1000);
  };
        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                Configure a integração para consulta e envio de títulos a protesto.
              </CardDescription>
            </div>
          </div>
        </CardHeader>
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input
                id="api-key"
                type="password"
                placeholder="Insira o Token de API da Cenprot"
                value={apiKey}
